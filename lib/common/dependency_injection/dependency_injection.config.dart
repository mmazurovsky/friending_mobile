...
import 'package:flutter_mobile_starter/common/auth/repo/auth_repo.dart' as _i22;
...
_i1.GetIt init(
  ...
  gh.lazySingleton<_i21.Uuid>(() => modules.uuid);
  gh.lazySingleton<_i22.AuthRepo>(() => _i22.FirebaseAuthRepoImpl(
        gh<_i8.FirebaseAuth>(),
        gh<_i6.CustomLogger>(),
      ));
  gh.lazySingleton<_i23.ConnectDS>(() => _i23.ConnectDSImpl(
  ...
  gh.lazySingleton<_i27.OtherUserProfileDS>(() => _i27.OtherUserProfileDSImpl(
        gh<_i18.RequestCheckWrapper>(),
        gh<_i10.FirebaseFirestore>(),
        gh<_i22.AuthRepo>(),
        gh<_i6.CustomLogger>(),
  ...
  gh.lazySingleton<_i34.ExploreStateManager>(() => _i34.ExploreStateManager(
