...
class _MyBottomNavBarState extends State<MyBottomNavBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return BottomNavigationBar(
      ...
      onTap: (tappedTabIndex) {
        ...
        if (tappedTabIndex == currentTab.index) {
          ...
          if (currentTab.tabNavigationKey.currentState!.canPop()) {
            currentTab.tabNavigationKey.currentState!.popUntil(
                ModalRoute.withName(currentTab.tabNavigationRoute.path));
          }
      ...
      items: [
        _getBottomNavigationBarItem(currentTab == NavigationTab.screen, NavigationTab.screen),
      ],
    );
  }
}
